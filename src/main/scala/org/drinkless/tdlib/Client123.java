 ...
 */
public final class Client123 implements Runnable {
    /**
     ...
     */
    public void setDefaultExceptionHandler(Client123.ExceptionHandler defaultExceptionHandler) {
     ...
     */
    public static Client123 create(ResultHandler updatesHandler, ExceptionHandler updatesExceptionHandler, ExceptionHandler defaultExceptionHandler) {
        Client123 client123 = new Client123(updatesHandler, updatesExceptionHandler, defaultExceptionHandler);
        new Thread(client123, "TDLib thread").start();
        return client123;
    }
    ...
    private Client123(ResultHandler updatesHandler, ExceptionHandler updateExceptionHandler, ExceptionHandler defaultExceptionHandler) {
